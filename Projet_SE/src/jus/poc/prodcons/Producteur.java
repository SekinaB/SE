...
public class Producteur extends Acteur implements _Producteur {
	...
	protected Producteur(ProdCons buffer, int identification, int nombreDeMessages, MyObservateur myobservateur,
	...
	public void run() {
		for (int i = 0; i < nombreDeMessages; i++) {
			try {
				...
				myobservateur.productionMessage(this, messageProd, tempsDeTraitement);
