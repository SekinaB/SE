...
public class Consommateur extends Acteur implements _Consommateur {
	...
	protected Consommateur(ProdCons buffer, int identification, MyObservateur myobservateur, int moyenneTempsDeTraitement,
	...
	public void run() {
		...
		while ((buffer.enAttente() > 0) || buffer.producteurAlive()) {
			try {
				...
				myobservateur.consommationMessage(this, messageCons, tempsDeTraitement);
