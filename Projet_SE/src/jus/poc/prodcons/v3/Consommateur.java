...
public class Consommateur extends Acteur implements _Consommateur {
	...
	public void run() {
		...
		while (true) {
			try {
				int consTime = Aleatoire.valeur(moyenneTempsDeTraitement, deviationTempsDeTraitement);
				sleep(consTime);
				val = (MessageX) buffer.get(this);
				this.observateur.consommationMessage(this, val, consTime);
				// System.out.println("Le consommateur " + this.identification +
				// " consomme " + val.toString());
			} catch (Exception e) {
